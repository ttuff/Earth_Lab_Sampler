...
```{r, warning=FALSE, message=FALSE,  fig.cap="Freshly constructed hexagonal sampling grid"}
# Define bounding box
...
```{r, warning=FALSE, message=FALSE, fig.cap="Hexagon grid laid over a distribution of iNaturalist points"}
