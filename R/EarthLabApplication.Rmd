...
#write.csv(gbifA, file="/Users/Ty/Dropbox/Dendritic connectivity/SUS2020/rawData/gbifA.csv")
#write.csv(gbifB, file="/Users/Ty/Dropbox/Dendritic connectivity/SUS2020/rawData/gbifB.csv")

mapview(gbif$decimalLatitude, gbif$decimalLongitude)
```
...
library(rgdal) 
#taxize::use_entrez()
#ENTREZ_KEY='cea17cb44a0c99a698e23e376ea83567ce08'
#usethis::edit_r_environ()
#unique(GBIF$scientificName)
...
data = list(y=y, z=z)
formula = y ~ 1+z
result = inla(formula, family = "gaussian", data = sp_GBIF)
